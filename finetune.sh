...
#SBATCH -o spurious_inject/finetuning/threeway_1500_20epo_%j.txt                    # Standard output file
#SBATCH -e spurious_inject/finetuning/threeway_1500_20epo_%j.txt                     # Standard error file
#SBATCH -J threeway_1500_20epo_                  # Job name
#SBATCH --array=1-5
...
python /projects/frink/wang.xil/med_spurious/spurious_inject/finetuning/finetune_olmo_spurious.py \
    ...
    --ratio 3 \
    --output-dir /projects/frink/wang.xil/med_spurious/spurious_inject/finetuning/data_mix_exp/threeway_1500_20epo_${SLURM_ARRAY_TASK_ID} \
    --max-epochs 10 \
    --lr 1e-4 \
    --wandb-project sft_llama_data_mix \
    --wandb-run-name threeway_1500_20epo_${SLURM_ARRAY_TASK_ID} \
    --skip-base-eval \
    --cot \
